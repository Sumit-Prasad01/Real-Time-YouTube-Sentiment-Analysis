...
#     mlflow.set_tracking_uri(MLFLOW_URI)  # Replace with your MLflow tracking URI
#     client = MlflowClient()
...
# Initialize the model and vectorizer (For Local model loading)
model, vectorizer = load_model("./lgbm_model.pkl", "./tfidf_vectorizer.pkl")  

# Initialize the model and vectorizer (For MLfow)
